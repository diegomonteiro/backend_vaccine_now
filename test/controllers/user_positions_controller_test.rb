...
class UserPositionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_position" do
    assert_difference('UserPosition.count') do
      post user_positions_url, params: { user_position: { accuracy: @user_position.accuracy, latitude: @user_position.latitude, longitude: @user_position.longitude, user_id: @user_position.user_id } }
    end
  ...
  test "should update user_position" do
    patch user_position_url(@user_position), params: { user_position: { accuracy: @user_position.accuracy, latitude: @user_position.latitude, longitude: @user_position.longitude, user_id: @user_position.user_id } }
