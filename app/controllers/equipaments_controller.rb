class EquipamentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @equipament.save
        format.html { redirect_to @equipament, notice: "Equipamento registrado com sucesso!" }
  ...
  def destroy
    @equipament.destroy
    respond_to do |format|
      format.html { redirect_to equipaments_url, notice: "Equipamento excluído com sucesso!" }
  ...
  private
    ...
    def equipament_params
      params.require(:equipament).permit(:cod, :manufacturer_id, :vaccination_point_id)
    end
end
